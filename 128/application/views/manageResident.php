...
<a href="goToAddDormer"><button>Add Dormer</button></a>
<a href="goToAddApplicant"><button>Applicants</button></a>
<a href="goToAddRoom"><button>Add Room</button></a>
<a href="goToAddEquipment"><button>Add Equipment</button></a>
<a href="goToAddViolation"><button>Add Violation</button></a>
<a href="goToAddPaymentRecord"><button>Add Payment Record</button></a>
<a href="goToAddDormer"><button>Remove Resident</button></a>
<a href="goToAddApplicant"><button>Produce Statement of Account</button></a>
<a href="goToAddRoom"><button>Edit Resident</button></a>
<a href="goToView"><button>View Resident</button></a>
<br />
        </section>
        <footer>
