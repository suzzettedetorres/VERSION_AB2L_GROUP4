...
<br/>
	...
	<input type="number" name="cnum" id="cnum" pattern="[0-9]{10}" value="<?php print $_cnum ; ?>" required/></td>
	</div>
    </td>
	</tr>
    ...
    <input type="text" id="eqname" name="eqname" value="<?php print $_eqname ; ?>" required/>
    </div></td>
	</tr>
    ...
    <input name="borday" id="borday" size="2" type="number" value="<?php print $_borday?>" min="1" max="31" required//>
    </div>
	<div class="input-control number inputStyle" id="Y">Year:<br />
    <input name="boryear" id="boryear" size="4" type="number" value="<?php print $_boryear?>" min="1909" max="2013" required//>
    </div>
    </div>
	</td>
	</tr>
    ...
    <input name="retday" id="retday" size="2" type=number value="<?php print $_retday?>" min="1" max="31" required//></div>
	<div class="input-control text inputStyle" id="Y">Year:<br />
    <input name="retyear" id="retyear" size="4" type=number value="<?php print $_retyear?>" min="1909" max="2013" required//>
	</div>
    </div>
    </td>
	</tr>
	...
	<tr>
	<td>Condition before borrowed date: </td>
    <td><div class="input-control text inputStyle">
    <input type="text" name="condb" id="condb" value="<?php print $_condb ; ?>" required/>
    </div></td>
	</tr>
	
	<tr>
	<td>Condition after returned date: </td>
    <td><div class="input-control text inputStyle">
    <input type="text" name="condr" id="condr" value="<?php print $_condr ; ?>" required/>
    </div></td>
	</tr>
	...
	<input type="submit" class="btn-three" value="Add Equipment" onclick="" />
	</td>
	</tr>
