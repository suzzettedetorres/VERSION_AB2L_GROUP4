...
<body onload="startTime()">	
   ...
   <div id="content">
    	<header>
            <h1>Choose Equipment to Remove</h1>
        </header>
        <section>
...
<form id="removeEquipment" name="removeEquipment" method="post" action="removeEquipment" onsubmit="">
	<table>
	<tbody>
	<?php
			foreach($equipments as $d){
				
				print  '<tr><td><pre> <label class="input-control radio"><input type="radio" name="eqid" value="'.$d['CONTROLNUMBER'].'"><span class="helper">  <b>Control Number: </b>'.$d['CONTROLNUMBER'].'</td><td><b>Equipment Name: </b>'.$d['EQUIPMENTNAME'].'</span></label></pre></td></tr>';
				
			}
	?>
	
	<td colspan='2'>
	<input type="submit" class="btn-three" value="Remove Equipment" onclick="" />
	</td>
	</tr>
	</table>
</form>
