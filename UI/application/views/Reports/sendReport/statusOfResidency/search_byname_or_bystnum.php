...
<body onload="startTime()">	
    ...
    <div id="content">
    	<header>
            <h1>Send Narrative Report</h1>
        </header>
        <section>
         <ul class="listview">
          <li>
           <div class="icon">
		   <a href="sendstat_searchByStudentNumber"><img src="../../img/search2.png" /></a>
           </div>
           <div class="data">
            <h4><a href="sendstat_searchByStudentNumber">Search by Student Number</a></h4>
            <p>Search resident by entering his/her student number.</p>
           </div>
          </li>
           <li>
           <div class="icon">
		   <a href="sendstat_searchByName"><img src="../../img/search2.png" /></a>
           </div>
           <div class="data">
            <h4><a href="sendstat_searchByName">Search by Name</a></h4>
