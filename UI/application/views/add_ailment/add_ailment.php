...
?>
<br/>
	<form id="AilmentForm" name="AilmentForm" method="post" action="addailment" onsubmit="">
	<table>
	<tbody>
	...
	<td>Ailment:</td>
    <td><div class="input-control text inputStyle">
    <input type="text" name="ailment" id="ailment" required/></div></td>
	</tr>
	
	<tr><td></td>
	<td style="text-align:left" colspan='2'>
	<input type="submit" class="btn-three" value="Add Ailment" onclick="" />
	</td></tr>
	</table>
</form>
<br />
