...
?>
<br/>
	<form id="AffiliationForm" name="AffiliationForm" method="post" action="addaffiliation" onsubmit="">
	<table>
	<tbody>
	...
	<td>Affiliation:</td>
    <td><div class="input-control text inputStyle">
    <input type="text" name="affiliation" id="affiliation" required/></div></td>
	</tr>
	
	<tr><td></td>
	<td style="text-align:left" colspan='2'>
	<input type="submit" class="btn-three" value="Add Affiliation" onclick="" />
	</td></tr>
	</table>
</form>
<br />
