...
<html>
<head>
<title>Update Borrowed Equipment</title>
...
<body onload="startTime()">	
    ...
    <div id="content">
    	<header>
            <h1>Update Borrowed Equipment</h1>
        </header>
        <section>
        <div id="box2">
        <ul class="listview">
		  <li>
           <div class="icon">
            <a href="goToAddBorrowedEquipment"><img src="../../img/addequip.png" /></a>
           </div>
           <div class="data">
            <h4><a href="goToAddBorrowedEquipment">Add a Dormer's Borrowed Equipment</a></h4>
            <p>Add a borrowed equipment to the record.</p>
           </div>
        </li>
		<li>
           <div class="icon">
            <a href="goTo_UpdateBorrowedEquipment"><img src="../../img/updateborrowed.png" /></a>
           </div>
           <div class="data">
            <h4><a href="goTo_UpdateBorrowedEquipment">Update a Dormer's Borrowed Equipment Record</a></h4>
            <p>Update a borrowed equipment record of dormer.</p>
           </div>
        </li>
          <!--<li>
           <div class="icon">
