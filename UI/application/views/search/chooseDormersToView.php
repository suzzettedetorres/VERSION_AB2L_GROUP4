...
<div id="infosheet">
<form id="viewDormer" name="viewDormer" method="post" action="searchDormers" onsubmit="">
	<table>
	<tbody>
	<?php
			foreach($data as $d){
	...
	<td colspan='2'>
	<input type="submit" class="btn-three" value="View Dormer" onclick="" />
	</td>
	</tr>
	</table>
</form>
