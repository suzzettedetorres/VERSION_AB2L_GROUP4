...
class Insert extends CI_Controller{
	...
	public function send_violationReport()
	{
		...
		if($result != NULL){
			...
			$this->load->view("Reports/sendReport/sendViolationReport/search_dormer_byname_or_bystnum.php");
		}
	}
	...
	public function addaffiliation(){
		...
		if($checkaffiliation == NULL){
			...
			echo "<script type='text/javascript'>alert('Affiliation record has been added.')</script>";
			$this->load->view("add_affiliation/search_byname_or_bystnum.php");
		}
		else{
			echo "<script type='text/javascript'>alert('Affiliation record of dormer already exists.')</script>";
			$this->load->view("add_affiliation/search_byname_or_bystnum.php");
		}
	}
	...
	public function addailment(){
		...
		if($checkailment == NULL){
			...
			echo "<script type='text/javascript'>alert('Ailment record has been added.')</script>";
			$this->load->view("add_ailment/search_byname_or_bystnum.php");
		}
		else{
			echo "<script type='text/javascript'>alert('Ailment record of dormer already exists.')</script>";
			$this->load->view("add_ailment/search_byname_or_bystnum.php");
		}
	}
	...
	public function addABorrowedEquipment() {
		...
		if($result != NULL){
			...
			if($equipments != NULL){
				...
				echo "<script type='text/javascript'>alert('No equipment to be borrowed')</script>";
				$this->load->view("update_borrowedequipment/add_borrowedequipment/search_byname_or_bystnum.php");
			}
		}
		else{
	...
	public function addborrowedequipment(){
		...
		if($checkborrowedkey == NULL){
			...
			if($checkavailability == NULL){
				...
				echo "<script type='text/javascript'>alert('Borrowed equipment record has been added.')</script>";
				$this->load->view("update_borrowedequipment/add_borrowedequipment/search_byname_or_bystnum.php");
			}
			else{
				echo "<script type='text/javascript'>alert('Equipment already borrowed by another dormer.')</script>";
				$this->load->view("update_borrowedequipment/add_borrowedequipment/search_byname_or_bystnum.php");
			}
		}
		else{
			echo "<script type='text/javascript'>alert('Dormer has already borrowed that equipment.')</script>";
			$this->load->view("update_borrowedequipment/add_borrowedequipment/search_byname_or_bystnum.php");
		}
	}
	...
	public function updateABorrowedEquipment() {
		...
		if($result != NULL){
			...
			if($equipments != NULL){
				...
				echo "<script type='text/javascript'>alert('The dormer didn\'t borrow any equipment.')</script>";
				$this->load->view("update_borrowedequipment/update_borrowedequipment/search_byname_or_bystnum.php");
			}
		}
		else{
	...
	public function updateborrowedequipment(){
		...
		$borrowedkey = $stnum.'_'.$control_number;
			...
			echo "<script type='text/javascript'>alert('Borrowed equipment has been returned.')</script>";
			$this->load->view("update_borrowedequipment/update_borrowedequipment/search_byname_or_bystnum.php");
	}
	...
	public function edit_AdminAccount(){
		...
		if($checkoldpassword != NULL){
			if($new_password == $new2_password){
				...
				echo "<script type='text/javascript'>alert('Account information changed.')</script>";
				$this->load->view('manageAdminAccount/manageAdminAccount.php');
			}
			else{
				echo "<script type='text/javascript'>alert('New password confirmation mismatched.')</script>";
				$this->load->view('manageAdminAccount/manageAdminAccount.php');
			}
		}
		else{
			echo "<script type='text/javascript'>alert('Wrong previous password.')</script>";
			$this->load->view('manageAdminAccount/manageAdminAccount.php');
		}
	}
	...
	public function removeAnEquipment(){
		...
		if($equipments != NULL){
			...
			echo "<script type='text/javascript'>alert('No existing equipment in the list.')</script>";
			$this->load->view("manageDorm/manageEquipment.php");
		}
	}
	...
	public function addequipment(){
		...
		if($checkEquipment == NULL){
			...
			echo "<script type='text/javascript'>alert('New dormitory equipment added.')</script>";
			$this->load->view("Main.php");
		}
		else{
	...
	public function removeEquipment() {
		...
		if($checkEquipment != NULL){
			...
			echo "<script type='text/javascript'>alert('Equipment removed.')</script>";
			$this->load->view("manageDorm/manageEquipment.php");
		}
		else{
			echo "<script type='text/javascript'>alert('Record is not in the equipment List.')</script>";
	...
	public function r_searchDormers() {
		...
		if($checkstnum != NULL){
			...
			{
				echo "<script type='text/javascript'>alert('The dormer has already paid for her account this month.')</script>";
				$this->load->view("create_PDF/r_search.php");
			}
		}
		else
