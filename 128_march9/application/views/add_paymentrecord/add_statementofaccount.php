...
<br/>
    ...
    <input type="text" name="prid" id="prid" value="<?php print $_prid; ?>" required/></div></td>
	</tr>
	
	<tr>
	<td>Statement of Account ID: </td>
	<td><div class="input-control text inputStyle">
    <input type="text" name="soaid" id="soaid" value="<?php print $_soaid; ?>" required/></div></td>
	</tr>
	...
	<input type="submit" class="btn-three" value="Add Statement of Account" onclick="" />
	</td>
	</tr>
