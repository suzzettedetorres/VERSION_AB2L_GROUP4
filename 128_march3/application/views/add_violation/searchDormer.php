...
<body onload="startTime()">	
    ...
    <div id="content">
       ...
       <br />
		...
		<a href="violation_searchADormerByStudentNumber"><button>Search by Student Number</button></a>
<a href="violation_searchADormerByName"><button>Search by Name</button></a>
		<br />
        </section>
        <footer>
