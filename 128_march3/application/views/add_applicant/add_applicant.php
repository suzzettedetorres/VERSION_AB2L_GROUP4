...
<table>
<tr>
<td><a href="goToAddDormer" class="btn">Add Dormer</a></td>
<td style="text-align:left"><a href="viewApplicants" class="btn">Reservation List</a></td>
</tr>
	<?php
		$_stnum = "2010-49621";
		$_fname = "Suzzette";
...
<tr>
	<td>Guardian ID:</td>
    <td><div class="input-control text inputStyle">
		<input type="text" name="guardianid" id="guardianid" value="<?php print $_guardianid; ?>" required/>
	</div></td>
    </tr>-->
    <tr>
    <td>First Name:</td>
