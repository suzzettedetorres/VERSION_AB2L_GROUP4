...
<body onload="startTime()">	
    ...
    <div id="content">
		...
		<li>
           <div class="icon">
            <a href="goToAddAffiliation"><img src="../../img/affiliation.png" /></a>
           </div>
           <div class="data">
            <h4><a href="goToAddAffiliation">Add a Dormer's Affiliation</a></h4>
            <p>Add an affiliation to a dormer's record.</p>
           </div>
        </li>
		<li>
           <div class="icon">
            <a href="goToAddAilment"><img src="../../img/ailment.png" /></a>
           </div>
           <div class="data">
            <h4><a href="goToAddAilment">Add a Dormer's Ailment</a></h4>
            <p>Add an ailment to a dormer's record.</p>
           </div>
        </li>
          <!--<li>
           <div class="icon">
		...
		<li>
           <div class="icon">
            <a href="goToAddMedication"><img src="../../img/med.png" /></a>
           </div>
           <div class="data">
            <h4><a href="goToAddMedication">Add a Dormer's Medication</a></h4>
            <p>Add a medication to a dormer's record.</p>
           </div>
        </li>
		<li>
           <div class="icon">
