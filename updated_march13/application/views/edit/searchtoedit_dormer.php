...
<body onload="startTime()">	
	...
	<ul class="listview">
          <li>
           <div class="icon">
            <a href="edit_searchBySNum"><img src="../../img/search2.png" /></a>
           </div>
           <div class="data">
            <h4><a href="edit_searchBySNum">Student Number</a></h4>
            <p>Search dormer to edit by entering student number.</p>
           </div>
          </li>
           <li>
           <div class="icon">
            <a href="edit_searchByName"><img src="../../img/search2.png" /></a>
           </div>
           <div class="data">
            <h4><a href="edit_searchByName">Name</a></h4>
            <p>Search dormer to edit by entering his/her name.</p>
           </div>
          </li>
         </ul>
