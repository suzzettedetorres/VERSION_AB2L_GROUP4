...
<form id="editDormer" name="editDormer" method="post" action="editDormers" onsubmit="">
	...
	<?php
			foreach($data as $d){
				...
				print  '<tr><td><pre> <label class="input-control radio"><input type="radio" name="stnum" value="'.$d['STUDENTNUMBER'].'"><span class="helper">  <b>Student Number: </b>'.$d['STUDENTNUMBER'].'</td><td> <b>Name: </b>'.$d['LASTNAME'].', '.$d['FIRSTNAME'].' '.$d['MIDDLENAME'].'</label></pre></td></tr>';
				
			}
	?>
	
	<td colspan='2'>
	<input type="submit" class="btn-three" value="Edit Dormer" onclick="" />
	</td>
	</tr>
	</table>
</form>
