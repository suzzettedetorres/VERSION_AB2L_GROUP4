...
<html>
<head>
<title>Choose Resident to View Violation</title>
...
<body onload="startTime()">	
    ...
    <div id="content">
    	<header>
            <h1>Choose Resident to View Violation</h1>
        </header>
        <section>
       <br />


<form id="viewViolationDormer" name="viewViolationDormer" method="post" action="viewViolation" onsubmit="">
	<table>
	<tbody>
	<?php
			foreach($data as $d){
