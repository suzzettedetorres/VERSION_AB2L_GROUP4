     ...
     <div id="content">
        ...
        <section>
         <ul class="listview">
           <li>
           <div class="icon">
		<a href="goToAddEquipment"><img src="../../img/equip.png" /></a>
           </div>
           <div class="data">
            <h4><a href="goToAddEquipment">Add Equipment</a></h4>
            <p>Add an equipment to the list.</p>
           </div>
          </li>
           <li>
           <div class="icon">
           ...
           <div class="data">
            ...
            <p>View all the equipments owned by the dormitory.</p>
           </div>
          </li>
		  <li>
           <div class="icon">
		   <a href="removeAnEquipment"><img src="../../img/removeequip.png" /></a>
           </div>
           <div class="data">
            <h4><a href="removeAnEquipment">Remove an Equipment</a></h4>
            <p>Remove an equipment owned by the dormitory in the list.</p>
           </div>
          </li>
         </ul>
       <br />
