     ...
     <div id="content">
        ...
        <section>
         <ul class="listview">
			<li>
           <div class="icon">
		   <a href="goToFinancial"><img src="../../img/addpayment.png" /></a>
           </div>
           <div class="data">
            <h4><a href="goToFinancial">Manage Financial Records</a></h4>
            <p>Manage financial records of the dormitory.</p>
           </div>
          </li>
		  <li>
           <div class="icon">
	<a href="goToManageRoom"><img src="../../img/addroom.png" /></a>
           </div>
           <div class="data">
            <h4><a href="goToManageRoom">Manage Dormitory Rooms</a></h4>
            <p>Manage rooms in the dormitory.</p>
           </div>
          </li>
		  <li>
           <div class="icon">
		<a href="goToManageEquipment"><img src="../../img/addequipment.png" /></a>
           </div>
           <div class="data">
            <h4><a href="goToManageEquipment">Manage Dormitory Equipments</a></h4>
            <p>Manage equipments owned by the dormitory.</p>
           </div>
          </li>
         </ul>
       <br />
