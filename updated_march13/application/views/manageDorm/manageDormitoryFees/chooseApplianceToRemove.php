...
<html>
<head>
<title>Choose Appliance to Remove</title>
...
<body onload="startTime()">	
    ...
    <div id="content">
    	<header>
            <h1>Choose Appliance to Remove</h1>
        </header>
        <section>
...
<div id="infosheet">
<form id="chooseAppliance" name="chooseAppliance" method="post" action="removeAppliance" onsubmit="">
	<table>
	<tbody>
	<?php
			foreach($appliancesfees as $a){
				
				print  '<tr><td><pre> <label class="input-control radio"><input type="radio" name="appliance" value="'.$a['APPLIANCE'].'"><span class="helper">  <b>Appliance : </b>'.$a['APPLIANCE'].'</td><td> <b>Appliance Fee : </b>'.$a['APPLIANCEFEE'].'</span></label></pre></td></tr>';
				
			}
	?>
	
	<td colspan='2'>
	<input type="submit" class="btn-three" value="Remove Appliance" onclick="" />
	</td>
	</tr>
	</table>
</form>
