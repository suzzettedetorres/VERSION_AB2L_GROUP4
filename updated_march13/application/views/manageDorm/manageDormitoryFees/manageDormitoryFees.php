...
<html>
<head>
<title>Manage Dormitory Fees</title>
...
<body onload="startTime()">	
	<div id="naviSub">
     ...
     <div id="content">
    	<header>
            <h1>Manage Dormitory Fees</h1>
        </header>
        <section>
         <ul class="listview">
			<li>
           <div class="icon">
		   <a href="goToupdate_STFAPBracketFees"><img src="../../img/search2.png" /></a>
           </div>
           <div class="data">
            <h4><a href="goToupdate_STFAPBracketFees">Update STFAP Bracket Fees</a></h4>
            <p>Update the assigned fees for each STFAP bracket.</p>
           </div>
          </li>
		  <li>
           <div class="icon">
		   <a href="goTomanage_AppliancesFees"><img src="../../img/search2.png" /></a>
           </div>
           <div class="data">
            <h4><a href="goTomanage_AppliancesFees">Manage Appliances Fees</a></h4>
            <p>Manage appliance fees.</p>
           </div>
          </li>
         </ul>
       <br />
