...
?>
<br/>
	<form id="medicationForm" name="medicationForm" method="post" action="addmedication" onsubmit="">
	<table>
	<tbody>
	...
	<td>Medication:</td>
    <td><div class="input-control text inputStyle">
    <input type="text" name="medication" id="medication" required/></div></td>
	</tr>
	
	<tr><td></td>
	<td style="text-align:left" colspan='2'>
	<input type="submit" class="btn-three" value="Add Medication" onclick="" />
	</td></tr>
	</table>
</form>
<br />
