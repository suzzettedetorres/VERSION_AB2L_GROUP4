    ...
    <div id="content">
       ...
       <br />
		 <ul class="listview">
          <li>
           <div class="icon">
		   <a href="violation_searchADormerByStudentNumber"><img src="../../img/search2.png" /></a>
           </div>
           <div class="data">
            <h4><a href="violation_searchADormerByStudentNumber">Student Number</a></h4>
            <p>Search resident by student number.</p>
           </div>
          </li>
           <li>
           <div class="icon">
           <a href="violation_searchADormerByName"><img src="../../img/search2.png" /></a>
           </div>
           <div class="data">
            <h4><a href="violation_searchADormerByName">Name</a></h4>
