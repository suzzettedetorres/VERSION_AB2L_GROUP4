...
class Insert extends CI_Controller{
	...
	public function viewGraduatingStudent()
	{
		...
		$result2= $this->Main_model->search_senior();
		if($result != NULL){
			$this->load->view('create_PDF/graduatingdormers',array('data'=>$result, 'senior'=>$result2));
		}
		else{
	...
	public function viewStatusOfResidency(){
		$data = $this->Main_model->get_dormerstatusofresidency();
		$this->load->view('create_PDF/statusofresidency',array('data'=>$data));
	}
	...
	public function goToRecordViolation()
	{
		$this->load->view("record_violation/record_violation.php");
	}
	
	//add violation
	public function goToAddViolation()
	{
		$this->load->view("record_violation/add_violation/searchDormer.php");
	}
	
	public function violation_searchADormerByStudentNumber(){
		$this->load->view("record_violation/add_violation/search_dormer_bystnum.php");
	}
	
	public function violation_searchADormerByName(){
		$this->load->view("record_violation/add_violation/search_dormer_byname.php");
	}
	...
	public function chooseDormersToAddViolation(){
		...
		if($result != NULL){
			$this->load->view('record_violation/add_violation/chooseDormersToAddViolation',array('data'=>$result));
		}
		else{
			$this->Main_model->notify_failed('Record is not in the Dormers\' List.');
			$this->load->view("record_violation/add_violation/searchDormer.php");
	...
	public function violation_searchDormers() {
		...
		if($result != NULL){
			$this->load->view('record_violation/add_violation/add_violation',array('data'=>$result));
		}
		else{
			$this->Main_model->notify_failed('Record is not in the Dormers\' List.');
			$this->load->view("record_violation/add_violation/searchDormer.php");
	...
	public function addviolation(){
		...
		$this->Main_model->add_violation_data($violationid, $violation, $violationdate, $remarks, $stnum, 'UNRESOLVED');
		
		$violations = $this->Main_model->get_violationdata($stnum);
		
		$month=date('m');
		$day=date('d');
		$year=date('Y');
		$v = 0;
		foreach($violations as $d){
			$v++;
		}
		if($v == 1){
			...
			$statusofresidency = 'Probation';
		}
		else if($v > 3){
			$statusofresidency = 'Expelled';
		}
		
		$this->Main_model->update_statusofresidency($stnum,$statusofresidency);
	...
	//update violation
	public function goToUpdateViolation()
	{
		$this->load->view("record_violation/update_violation/searchDormer.php");
	}
	
	public function uviolation_searchADormerByStudentNumber(){
		$this->load->view("record_violation/update_violation/search_dormer_bystnum.php");
	}
	
	public function uviolation_searchADormerByName(){
		$this->load->view("record_violation/update_violation/search_dormer_byname.php");
	}
	
	public function chooseDormersToUpdateViolation(){
		...
		if($result != NULL){
			$this->load->view('record_violation/update_violation/chooseDormersToUpdateViolation',array('data'=>$result));
		}
		else{
			$this->Main_model->notify_failed('Record is not in the Dormers\' List.');
			$this->load->view("record_violation/update_violation/searchDormer.php");
	...
	public function uviolation_searchDormers() {
		...
		if($result != NULL){
			$violations = $this->Main_model->get_violationdata($stnum);
			if($violations != NULL)
				$this->load->view('record_violation/update_violation/update_violation',array('data'=>$result, 'violations'=>$violations));
			else{
	...
	public function updateviolation(){
		...
		$this->Main_model->update_violation_data($violationid);
		...
		$this->Main_model->notify_successful('The violation record has been marked as RESOLVED.');
		$this->load->view("Main.php");
	}
	//end update violation
	...
	public function addAnAffiliation() {
		...
		$result = $this->Main_model->search_dormer($stnum);
		if($result != NULL){
			$this->load->view('update_affiliation/add_affiliation/add_affiliation',array('data'=>$result));
		}
		else{
			$this->Main_model->notify_failed('Record is not in the Dormers\' List.');
			$this->load->view("update_affiliation/add_affiliation/search_byname_or_bystnum.php");
		}
	}
	...
	public function chooseDormersToAddAffiliation(){
		...
		if($result != NULL){
			$this->load->view('update_affiliation/add_affiliation/chooseDormersToAddAffiliation',array('data'=>$result));
		}
		else{
			$this->Main_model->notify_failed('Record is not in the Dormers\' List.');
			$this->load->view("update_affiliation/add_affiliation/search_byname_or_bystnum.php");
	...
	public function removeAnAffiliation() {
	
		$stnum = $_POST['stnum'];
		
		$result = $this->Main_model->search_dormer($stnum);
		if($result != NULL){
			$affiliations = $this->Main_model->get_dormeraffiliation($stnum);
			if($affiliations != NULL)
				$this->load->view('update_affiliation/remove_affiliation/remove_affiliation',array('data'=>$result,'affiliations'=>$affiliations));
			else{
				$this->Main_model->notify_failed('Dormer has no recorded affiliation.');
				$this->load->view("update_affiliation/remove_affiliation/search_byname_or_bystnum.php");
			}
		}
		else{
			$this->Main_model->notify_failed('Record is not in the Dormers\' List.');
	...
	public function chooseDormersToRemoveAffiliation(){
		...
		if($result != NULL){
			$this->load->view('update_affiliation/remove_affiliation/chooseDormersToRemoveAffiliation',array('data'=>$result));
		}
		else{
			$this->Main_model->notify_failed('Record is not in the Dormers\' List.');
			$this->load->view("update_affiliation/remove_affiliation/search_byname_or_bystnum.php");
	...
	public function removeaffiliation(){
		...
		//$checkaffiliation = $this->Main_model->check_dormer_affiliation($affiliationid);
		//if($checkaffiliation == NULL){
			$this->Main_model->remove_dormer_affiliation($affiliationid);
			$this->Main_model->notify_successful('The affiliation record has been removed.');
			$this->load->view("update_affiliation/remove_affiliation/search_byname_or_bystnum.php");
		//}
		//else{
		//	$this->Main_model->notify_failed('Affiliation record of dormer already exists.');
	...
	public function chooseDormersToAddAilment(){
		...
		if($result != NULL){
			$this->load->view('update_ailment/add_ailment/chooseDormersToAddAilment',array('data'=>$result));
		}
		else{
			$this->Main_model->notify_failed('Record is not in the Dormers\' List.');
			$this->load->view("update_ailment/add_ailment/search_byname_or_bystnum.php");
		}
	}
	...
	public function addAnAilment() {
		...
		$result = $this->Main_model->search_dormer($stnum);
		if($result != NULL){
			$this->load->view('update_ailment/add_ailment/add_ailment',array('data'=>$result));
		}
		else{
			$this->Main_model->notify_failed('Record is not in the Dormers\' List.');
			$this->load->view("update_ailment/add_ailment/search_byname_or_bystnum.php");
	...
	public function chooseDormersToRemoveAilment(){
		...
		if($result != NULL){
			$this->load->view('update_ailment/remove_ailment/chooseDormersToRemoveAilment',array('data'=>$result));
		}
		else{
			$this->Main_model->notify_failed('Record is not in the Dormers\' List.');
			$this->load->view("update_ailment/remove_ailment/search_byname_or_bystnum.php");
		}
	}
	
	public function removeAnAilment() {
	
		$stnum = $_POST['stnum'];
		
		$result = $this->Main_model->search_dormer($stnum);
		if($result != NULL){
			$ailment = $this->Main_model->get_dormerailment($stnum);
			if($ailment != NULL)
				$this->load->view('update_ailment/remove_ailment/remove_ailment',array('data'=>$result,'ailment'=>$ailment));
			else{
				$this->Main_model->notify_failed('Dormer has no recorded ailment.');
				$this->load->view("update_ailment/remove_ailment/search_byname_or_bystnum.php");
			}
		}
		else{
	...
	public function removeailment(){
		$stnum  = $_POST['stnum'];
		$ailmentid = $_POST['ailmentid'];
		//$ailmentid = $stnum.'_'.$ailment;
		//$checkailment = $this->Main_model->check_dormer_ailment($ailmentid);
		//if($checkailment == NULL){
			$this->Main_model->remove_dormer_ailment($ailmentid);
			$this->Main_model->notify_successful('An ailment record has been removed.');
			$this->load->view("update_ailment/remove_ailment/search_byname_or_bystnum.php");
		//}
		//else{
		//	$this->Main_model->notify_failed('Ailment record of dormer already exists.');
	...
	public function addAMedication() {
		...
		$result = $this->Main_model->search_dormer($stnum);
		if($result != NULL){
			$this->load->view('update_medication/add_medication/add_medication',array('data'=>$result));
		}
		else{
			$this->Main_model->notify_failed('Record is not in the Dormers\' List.');
			$this->load->view("update_medication/add_medication/search_byname_or_bystnum.php");
		}
	}
	...
	public function chooseDormersToAddMedication(){
		...
		if($result != NULL){
			$this->load->view('update_medication/add_medication/chooseDormersToAddMedication',array('data'=>$result));
		}
		else{
			$this->Main_model->notify_failed('Record is not in the Dormers\' List.');
			$this->load->view("update_medication/add_medication/search_byname_or_bystnum.php");
	...
	public function removeAMedication() {
	
		$stnum = $_POST['stnum'];
		
		$result = $this->Main_model->search_dormer($stnum);
		if($result != NULL){
			$medication = $this->Main_model->get_dormermedication($stnum);
			$this->load->view('update_medication/remove_medication/remove_medication',array('data'=>$result,'medication'=>$medication));
		}
		else{
			$this->Main_model->notify_failed('Record is not in the Dormers\' List.');
			$this->load->view("update_medication/remove_medication/search_byname_or_bystnum.php");
		}
	}
	...
	public function removemedication(){
		...
		//$checkmedication = $this->Main_model->check_dormer_medication($medicationid);
		//if($checkmedication == NULL){
			$this->Main_model->remove_dormer_medication($medicationid);
			$this->Main_model->notify_successful('A medication record has been removed.');
			$this->load->view("update_medication/remove_medication/search_byname_or_bystnum.php");
		//}
		//else{
		//	$this->Main_model->notify_failed('Medication record of dormer already exists.');
	...
	public function chooseDormersToRemoveMedication(){
		...
		if($result != NULL){
			$this->load->view('update_medication/remove_medication/chooseDormersToRemoveMedication',array('data'=>$result));
		}
		else{
			$this->Main_model->notify_failed('Record is not in the Dormers\' List.');
			$this->load->view("update_medication/remove_medication/search_byname_or_bystnum.php");
	...
	public function goToUpdateAffiliation(){
		$this->load->view("update_affiliation/update_affiliation.php");
	}
	
	public function goToUpdateAilment(){
		$this->load->view("update_ailment/update_ailment.php");
	}
	
	public function goToUpdateMedication(){
		$this->load->view("update_medication/update_medication.php");
	}
	...
	public function goToRemoveAffiliation(){
		$this->load->view("update_affiliation/remove_affiliation/search_byname_or_bystnum.php");
	}
	...
	public function goToRemoveAilment(){
		$this->load->view("update_ailment/remove_ailment/search_byname_or_bystnum.php");
	}
	...
	public function goToRemoveMedication(){
		$this->load->view("update_medication/remove_medication/search_byname_or_bystnum.php");
	}
	...
	public function goToUpdate_Appliances(){
		$this->load->view("update_dormer_appliance/update_dormer_appliance.php");
	}
	...
	public function goToAddDormerAppliance(){
		$this->load->view("update_dormer_appliance/add_appliance/search_byname_or_bystnum.php");
	}
	
	public function goTo_RemoveDormerAppliance(){
		$this->load->view("update_dormer_appliance/remove_appliance/search_byname_or_bystnum.php");
	}
	
	public function chooseDormersToAddAppliance(){
		...
		if($result != NULL){
			$this->load->view('update_dormer_appliance/add_appliance/chooseDormersToAddAppliance',array('data'=>$result));
		}
		else{
			$this->Main_model->notify_failed('Record is not in the Dormers\' List.');
			$this->load->view("update_dormer_appliance/add_appliance/search_byname_or_bystnum.php");
	...
	public function addAnAppliance() {
	
		$stnum = $_POST['stnum'];
		
		$result = $this->Main_model->search_dormer($stnum);
		if($result != NULL){
			$allappliances = $this->Main_model->appliancefee_viewer();
			if($allappliances != NULL){
				$this->load->view('update_dormer_appliance/add_appliance/add_appliance',array('data'=>$result,'allappliances'=>$allappliances));
			}
			else{
				$this->Main_model->notify_failed('There are no listed allowed appliance in the dormitory.');
				$this->load->view("update_dormer_appliance/add_appliance/search_byname_or_bystnum.php");
			}
		}
		else{
	...
	public function addappliance(){
		...
		//$date_returned = $_POST['retmonth'].'-'.$_POST['retday'].'-'.$_POST['retyear'];
		$appliance = $_POST['appliance'];
		$control_number = $stnum.'_'.$appliance;
		//$condr= $_POST['condr'];
		//$borrowedkey = $stnum.'_'.$control_number;
		//$checkborrowedkey = $this->Main_model->check_dormer_borrowedkey($borrowedkey);
		//if($checkborrowedkey == NULL){
			$checkapp = $this->Main_model->check_appliance($control_number);
			if($checkapp == NULL){
				$this->Main_model->add_dormer_appliance($stnum, $control_number, $appliance);
				$this->Main_model->notify_successful('An appliance record has been added.');
				$this->load->view("update_dormer_appliance/add_appliance/search_byname_or_bystnum.php");
			}
			else{
				$this->Main_model->notify_failed('Appliance already in the dormer\'s record.');
				$this->load->view("update_dormer_appliance/add_appliance/search_byname_or_bystnum.php");
			}
		//}
		//else{
	...
	public function chooseDormersToRemoveAppliance(){
		...
		if($result != NULL){
			$this->load->view('update_dormer_appliance/remove_appliance/chooseDormersToRemoveAppliance',array('data'=>$result));
		}
		else{
			$this->Main_model->notify_failed('Record is not in the Dormers\' List.');
			$this->load->view("update_dormer_appliance/remove_appliance/search_byname_or_bystnum.php");
	...
	public function removeAnAppliance() {
	
		$stnum = $_POST['stnum'];
		
		$result = $this->Main_model->search_dormer($stnum);
		if($result != NULL){
			$her_appliances = $this->Main_model->get_appliancelist($stnum);
			if($her_appliances != NULL){
				$this->load->view('update_dormer_appliance/remove_appliance/remove_appliance',array('data'=>$result,'appliances'=>$her_appliances));
			}
			else{
				$this->Main_model->notify_failed('The dormer didn\'t have any recorded appliances.');
				$this->load->view("update_dormer_appliance/remove_appliance/search_byname_or_bystnum.php");
			}
		}
		else{
	...
	public function remove_appliance(){
		//$stnum = $_POST['stnum'];
		$control_number = $_POST['control_number'];
		//$date_borrowed = $_POST['bormonth'].'-'.$_POST['borday'].'-'.$_POST['boryear'];
		//$date_returned = $_POST['retmonth'].'-'.$_POST['retday'].'-'.$_POST['retyear'];
		//$condr= $_POST['condr'];
		//$borrowedkey = $stnum.'_'.$control_number;
			$this->Main_model->remove_dormer_appliance($control_number);
			$this->Main_model->notify_successful('A dormer\'s appliance record has been removed.');
			$this->load->view("update_dormer_appliance/remove_appliance/search_byname_or_bystnum.php");
	}
	...
	{
		$this->load->view("update_affiliation/add_affiliation/search_dormer_bystnum.php");
	}
	
	public function aff_searchByName()
	{
		$this->load->view("update_affiliation/add_affiliation/search_dormer_byname.php");
	}
	
	public function raff_searchByStudentNumber()
	{
		$this->load->view("update_affiliation/remove_affiliation/search_dormer_bystnum.php");
	}
	
	public function raff_searchByName()
	{
		$this->load->view("update_affiliation/remove_affiliation/search_dormer_byname.php");
	}
	
	public function ail_searchByStudentNumber()
	{
		$this->load->view("update_ailment/add_ailment/search_dormer_bystnum.php");
	}
	
	public function ail_searchByName()
	{
		$this->load->view("update_ailment/add_ailment/search_dormer_byname.php");
	}
	
	public function rail_searchByStudentNumber()
	{
		$this->load->view("update_ailment/remove_ailment/search_dormer_bystnum.php");
	}
	
	public function rail_searchByName()
	{
		$this->load->view("update_ailment/remove_ailment/search_dormer_byname.php");
	}
	
	public function med_searchByStudentNumber()
	{
		$this->load->view("update_medication/add_medication/search_dormer_bystnum.php");
	}
	
	public function med_searchByName()
	{
		$this->load->view("update_medication/add_medication/search_dormer_byname.php");
	}
	
	public function rmed_searchByStudentNumber()
	{
		$this->load->view("update_medication/remove_medication/search_dormer_bystnum.php");
	}
	
	public function rmed_searchByName()
	{
		$this->load->view("update_medication/remove_medication/search_dormer_byname.php");
	}
	...
	public function dapp_searchByStudentNumber()
	{
		$this->load->view("update_dormer_appliance/add_appliance/search_dormer_bystnum.php");
	}
	
	public function dapp_searchByName()
	{
		$this->load->view("update_dormer_appliance/add_appliance/search_dormer_byname.php");
	}
	
	public function removedapp_searchByStudentNumber()
	{
		$this->load->view("update_dormer_appliance/remove_appliance/search_dormer_bystnum.php");
	}
	
	public function removedapp_searchByName()
	{
		$this->load->view("update_dormer_appliance/remove_appliance/search_dormer_byname.php");
	}
	...
	public function searchDormers() {
		...
		$result = $this->Main_model->search_dormer($stnum);
		if($result != NULL){
			$bequipments = $this->Main_model->check_dormer_borrowedequipment($stnum);
			$equipments = $this->Main_model->equipment_viewer();
			$appliances = $this->Main_model->get_appliancelist($stnum);
			$res = $this->Main_model->get_guardianId($stnum);
			foreach($res as $r){
				$guardianid = $r['GUARDIANID'];
			}
			$guardian_info = $this->Main_model->get_guardianinfo($guardianid);
			$affiliation = $this->Main_model->get_dormeraffiliation($stnum);
			$ailment = $this->Main_model->get_dormerailment($stnum);
			$medication = $this->Main_model->get_dormermedication($stnum);
			$this->load->view('view/view_Adormer',array('data'=>$result,'equipments'=>$equipments,'bequipments'=>$bequipments,'appliances'=>$appliances, 'guardian'=>$guardian_info,'affiliation'=>$affiliation,'ailment'=>$ailment,'medication'=>$medication));
		}
		else{
			$this->Main_model->notify_failed('Record is not in the Dormers\' List.');
			$this->load->view("search/search_dormer.php");
