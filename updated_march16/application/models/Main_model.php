...
class Main_model extends CI_Model{
	...
	public function add_violation_data($violationid, $violation, $violationdate, $remarks, $stnum, $isresolved){
		$this->db->query("Insert into CMSC128.VIOLATIONDATA(VIOLATIONID, VIOLATION, DATEOFVIOLATION, REMARK, STUDENTNUMBER, ISRESOLVED) values ('$violationid', '$violation', '$violationdate', '$remarks', '$stnum', '$isresolved')");
	}
	...
	public function add_dormer_appliance($stnum, $control_number, $appliance){
		$this->db->query("Insert into CMSC128.APPLIANCE(STUDENTNUMBER,CONTROLNUMBER,APPLIANCE) values ('$stnum','$control_number','$appliance')");
	}
	...
	{
		return $this->db->query("select * from VIOLATIONDATA where STUDENTNUMBER = '$stnum' and ISRESOLVED = 'UNRESOLVED'")->result_array();
	}
	...
	*/
	...
	public function update_violation_data($violationid){
		$this->db->query("UPDATE VIOLATIONDATA SET ISRESOLVED='RESOLVED' where VIOLATIONID = '$violationid' and ISRESOLVED = 'UNRESOLVED'");
	}
	...
	public function remove_dormer_affiliation($affiliationid)
	{
		return $this->db->query("delete from DORMER_AFFILIATION where AFFILIATION_ID = '$affiliationid'");
	}
	...
	public function remove_dormer_ailment($ailmentid)
	{
		return $this->db->query("delete from DORMER_AILMENT where AILMENT_KEY = '$ailmentid'");
	}
	...
	public function remove_dormer_medication($medicationid)
	{
		return $this->db->query("delete from DORMER_MEDICATION where MEDICATION_KEY = '$medicationid'");
	}
	...
	public function get_dormeraffiliation($stnum)
	{
		return $this->db->query("select * from DORMER_AFFILIATION where STUDENTNUMBER = '$stnum'")->result_array();
	}
	
	public function get_dormerailment($stnum)
	{
		return $this->db->query("select * from DORMER_AILMENT where STUDENTNUMBER = '$stnum'")->result_array();
	}
	
	public function get_dormermedication($stnum)
	{
		return $this->db->query("select * from DORMER_MEDICATION where STUDENTNUMBER = '$stnum'")->result_array();
	}
	
	public function get_dormerstatusofresidency()
	{
		return $this->db->query("select STUDENTNUMBER,FIRSTNAME,MIDDLENAME,LASTNAME,STATUSOFRESIDENCY from DORMER")->result_array();
	}
	...
	public function search_violations(){
		return $this->db->query("select * from VIOLATIONDATA where ISRESOLVED = 'UNRESOLVED'" )->result_array();
	}
	...
	public function check_appliance($control_number){
		return $this->db->query("select * from APPLIANCE where CONTROLNUMBER = '$control_number'")->result_array();
	}
	...
	public function remove_dormer_appliance($control_number)
	{
		return $this->db->query("delete from APPLIANCE where CONTROLNUMBER = '$control_number'");
	}
