...
<div id="infosheet">
       ...
       <br />
<form id="searchtoeditDormer" name="searchtoeditDormer" method="post" action="t_chooseDormersToView" onsubmit="">
	<table>
	<tr>
	<td>Name: </td>
	<td><div class="input-control text inputStyle"><input type="text" name="name" id="name" required/></div></td>
	</tr>
