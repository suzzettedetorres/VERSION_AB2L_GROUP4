    ...
    <div id="content">
        ...
        <section>
         <ul class="listview">
          <li>
           <div class="icon">
		   <a href="add_applicant"><img src="../../img/addapplicant.png" /></a>
           </div>
           <div class="data">
            <h4><a href="add_applicant">Reserve Applicant</a></h4>
            <p>Add a record of applicant to the reservation list.</p>
           </div>
          </li>
           <li>
           <div class="icon">
		   <a href="viewApplicants"><img src="../../img/viewapplicant.png" /></a>
           </div>
           <div class="data">
            <h4><a href="viewApplicants">View Reservation List</a></h4>
            <p>View records in the reservation list of applicants.</p>
           </div>
          </li>
         </ul>
        </section>
