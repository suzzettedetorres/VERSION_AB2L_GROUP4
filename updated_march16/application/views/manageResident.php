		...
		<div id="half2">
         <ul class="listview">
	      <li>
           ...
           <li>
           <div class="icon">
		<a href="goToRecordViolation"><img src="../../img/addviolation.png" /></a>
           </div>
           <div class="data">
            <h4><a href="goToRecordViolation">Manage Violation Records</a></h4>
            <p>Manage the violation records committed by the dormers.</p>
           </div>
          </li>
		  <li>
		</ul>
