...
<html>
<head>
<title>Manage Violation Records</title>
...
<body onload="startTime()">	
    ...
    <div id="content">
    	<header>
            <h1>Manage Violation Records</h1>
        </header>
        <section>
        <div id="box2">
        <div id="half">
        <ul class="listview">
		  <li>
           <div class="icon">
            <a href="goToAddViolation"><img src="../../img/editdormer.png" /></a>
           </div>
           <div class="data">
            <h4><a href="goToAddViolation">Add Dormer's Violation Record</a></h4>
            <p>Add a Dormer's Violation Record.</p>
           </div>
        </li>
		<li>
           <div class="icon">
            <a href="goToUpdateViolation"><img src="../../img/affiliation.png" /></a>
           </div>
           <div class="data">
            <h4><a href="goToUpdateViolation">Update a Dormer's Violation Record</a></h4>
            <p>Update a dormer's violation record.</p>
           </div>
        </li>
         </ul>
         </div>
