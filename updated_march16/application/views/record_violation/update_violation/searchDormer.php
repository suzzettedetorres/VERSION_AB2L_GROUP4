    ...
    <div id="content">
       ...
       <br />
		 <ul class="listview">
          <li>
           <div class="icon">
		   <a href="uviolation_searchADormerByStudentNumber"><img src="../../img/search2.png" /></a>
           </div>
           <div class="data">
            <h4><a href="uviolation_searchADormerByStudentNumber">Student Number</a></h4>
            <p>Search resident by student number.</p>
           </div>
          </li>
           <li>
           <div class="icon">
           <a href="uviolation_searchADormerByName"><img src="../../img/search2.png" /></a>
           </div>
           <div class="data">
            <h4><a href="uviolation_searchADormerByName">Name</a></h4>
            <p>Search resident by Name.</p>
           </div>
          </li>
         </ul>
