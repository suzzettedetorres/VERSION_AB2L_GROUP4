...
<html>
<head>
<title>Update Dormer's Violation</title>
...
<body onload="startTime()">	
    ...
    <div id="content">
    	<header>
            <h1>Update Dormer's Violation</h1>
        </header>
        <section>
...
<form id="searchDormer" name="searchDormer" method="post" action="chooseDormersToUpdateViolation" onsubmit="">
	<table>
	<tr>
	<td>Name: </td>
