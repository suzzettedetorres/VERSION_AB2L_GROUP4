...
<html>
<head>
<title>Update Dormer's Violation Record</title>
...
<body onload="startTime()">	
    ...
    <div id="content">
    	<header>
            <h1>Update Dormer's Violation Record</h1>
        </header>
        <section>
...
?>
<br/>
	<form id="ViolationForm" name="Violation" method="post" action="updateviolation" onsubmit="">
	<table>
	<tbody>
	
	<input type="hidden" name="stnum" id="stnum" pattern="[0-9]{4}-[0-9]{5}" value="<?php print $_stnum ; ?>"  required/></div></td>
	
	<?php
		foreach($violations as $v){
			echo  '<tr><td><input type="radio" name="violationid" value="'.$v['VIOLATIONID'].'">Violation : '.$v['VIOLATION'].'</td></tr><br/>';
			echo '<tr><td> Date of Violation : '.$v['DATEOFVIOLATION'].'</td></tr>';
			echo '<tr><td> Remark : '.$v['REMARK'].'</td></tr>';
			echo '<tr><td> Status of Violation : '.$v['ISRESOLVED'].'</td></tr>';
		}
	?>
	
	<tr><td></td>
	<td style="text-align:left" colspan='2'>
	<input type="submit" class="btn-three" value="Mark Violation as RESOLVED" onclick="" />
	</td></tr>
	</table>
</form>
<br />
