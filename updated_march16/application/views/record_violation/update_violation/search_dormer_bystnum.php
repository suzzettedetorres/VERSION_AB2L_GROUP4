...
<div id="infosheet">
       <br />
		...
		<form id="searchDormer" name="searchDormer" method="post" action="uviolation_searchDormers" onsubmit="">
	<table>
	<tbody>
	<tr>
	<td>Student Number: </td>
	<td><div class="input-control text inputStyle">
    <input type="text" name="stnum" id="stnum" pattern="[0-9]{4}-[0-9]{5}" required/></div></td>
	</tr>
	<tr>
    <td></td>
	<td colspan='2'>
	<input type="submit" class="btn-three" value="Search Dormer" onclick="" />
	</td>
	</tr>
	</table>
	</form>
