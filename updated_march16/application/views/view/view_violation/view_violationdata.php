...
<html>
<head>
<title>View Violation Data</title>
...
<?php
			foreach($name as $n){
				echo '<h2>'.$n['LASTNAME'].', '.$n['FIRSTNAME'].' '.$n['MIDDLENAME'].'<br />';
				echo 'Student Number: '.$n['STUDENTNUMBER'].'</h2><br />';
			}
			foreach($data as $d){
				
				echo '<br/>VIOLATION ID: ',$d['VIOLATIONID'],'<br />';
				echo 'VIOLATION: ',$d['VIOLATION'],'<br />';
				echo 'DATE: ',$d['DATEOFVIOLATION'],'<br />';
				echo 'REMARK: ',$d['REMARK'],'<br />';
