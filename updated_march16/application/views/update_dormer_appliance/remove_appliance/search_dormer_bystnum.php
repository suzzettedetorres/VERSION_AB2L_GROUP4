...
<html>
<head>
<title>Remove Dormer's Appliances Record</title>
...
<body onload="startTime()">	
    ...
    <div id="content">
    	<header>
            <h1>Remove Dormer's Appliances Record</h1>
        </header>
        <section>
       <br />
			   
		<form id="removeAppliance" name="removeAppliance" method="post" action="removeAnAppliance" onsubmit="">
	<table>
	<tbody>
	<tr>
