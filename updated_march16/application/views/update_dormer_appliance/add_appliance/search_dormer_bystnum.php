...
<html>
<head>
<title>Add Dormer's Appliance Record</title>
...
<body onload="startTime()">	
    ...
    <div id="content">
    	<header>
            <h1>Add Dormer's Appliance Record</h1>
        </header>
        <section>
       <br />
			   
		<form id="addAppliance" name="addAppliance" method="post" action="addAnAppliance" onsubmit="">
	<table>
	<tbody>
	<tr>
