...
?>
<br/>
	<form id="borrowedequipmentForm" name="borrowedequipmentForm" method="post" action="addappliance" onsubmit="">
	<table>
	<tbody>
	...
	<?php
	foreach ($allappliances as $listed_items) {
		echo "<option value=".$listed_items['APPLIANCE'].">".$listed_items['APPLIANCE']."</option>";
	}
	?>
	</select>
	</div>
