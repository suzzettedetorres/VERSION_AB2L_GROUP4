...
<html>
<head>
<title>Update Dormer's Appliance Record</title>
...
<body onload="startTime()">	
    ...
    <div id="content">
    	<header>
            <h1>Update Dormer's Appliance Record</h1>
        </header>
        <section>
        <div id="box2">
        <ul class="listview">
		  <li>
           <div class="icon">
            <a href="goToAddDormerAppliance"><img src="../../img/addequip.png" /></a>
           </div>
           <div class="data">
            <h4><a href="goToAddDormerAppliance">Add a Dormer's Appliance</a></h4>
            <p>Add an appliance to the record.</p>
           </div>
        </li>
		<li>
           <div class="icon">
            <a href="goTo_RemoveDormerAppliance"><img src="../../img/updateborrowed.png" /></a>
           </div>
           <div class="data">
            <h4><a href="goTo_RemoveDormerAppliance">Remove a Dormer's Appliance Record</a></h4>
            <p>Remove an appliance record of dormer.</p>
           </div>
        </li>
          <!--<li>
           <div class="icon">
