...
<body onload="startTime()">	
	<div id="naviSub">
     ...
     <div id="content">
    	<header>
            <h1>Manage Administrator Account</h1>
        </header>
        <section>
         <ul class="listview">
			<li>
           <div class="icon">
            <a href="editAdminAccount"><img src="../../img/Edit.png" /></a>
           </div>
           <div class="data">
            <h4><a href="editAdminAccount">Edit Administrator Account</a></h4>
            <p>Edit Administrator Account.</p>
           </div>
        </li>
