...
<div id="infosheet">
       <br />
<?php
		foreach($adminaccount as $d){
			$_username = $d['USERNAME'];
			$_password = $d['PASSWORD'];
		}
	?>
	<form id="adminForm" name="adminForm" method="post" action="edit_AdminAccount" onsubmit="">
	<table>
	<tr>
	<td>Username: </td>
	<td><div class="input-control text inputStyle">
    <input type="text" name="username" id="username" value="<?php print $_username ; ?>"  required/>
    </div></td>
	</tr>
	<tr>
	<td>Previous Password: </td>
	<td><div class="input-control text inputStyle">
    <input type="password" name="previous_password" id="previous_password" required/></div></td>
	</tr>
	<tr>
	<td>New Password: </td>
	<td><div class="input-control text inputStyle">
    <input type="password" name="new_password" id="new_password" required/></div></td>
	</tr>
	<tr>
	<td>Confirm New Password: </td>
	<td><div class="input-control text inputStyle">
    <input type="password" name="new2_password" id="new2_password" required/></div></td>
	</tr>
	</table>
    <input type="submit" class="btn-three" value="Edit Administrator Account" onclick="" style="margin:8% 32%;"/>
	</form>
<br />
        </section>
        <footer>
