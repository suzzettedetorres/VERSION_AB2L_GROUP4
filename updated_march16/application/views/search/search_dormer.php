...
<body onload="startTime()">	
    ...
    <div id="content">
       ...
       <ul class="listview">
          <li>
           <div class="icon">
		   <a href="searchADormerByStudentNumber"><img src="../../img/search2.png" /></a>
           </div>
           <div class="data">
            <h4><a href="searchADormerByStudentNumber">Student Number</a></h4>
            <p>Search resident by student number.</p>
           </div>
          </li>
           <li>
           <div class="icon">
            <a href="searchADormerByName"><img src="../../img/search2.png" /></a>
           </div>
           <div class="data">
            <h4><a href="searchADormerByName">Name</a></h4>
