...
<body onload="startTime()">	
    ...
    <div id="content">
	   ...
	   <ul class="listview">
          <li>
           <div class="icon">
            <a href="manualAddDormer"><img src="../../img/adddormer2.png" /></a>
           </div>
           <div class="data">
<h4><a href="manualAddDormer">Add Dormer Manually</a></h4>
<p>Add a dormer by manually entering information of applicant.</p>
           </div>
          </li>
           <li>
           <div class="icon">
            <a href="addDormerFromReservationList"><img src="../../img/reservelist.png" /></a>
           </div>
           <div class="data">
<h4><a href="addDormerFromReservationList">Choose From Reservation List</a></h4>
