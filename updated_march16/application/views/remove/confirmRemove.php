...
function checkStuff()
{
	var check1=confirm("Are you sure you want to remove the dormer's record?");
	if (check1)
	{
		var check2=confirm("For the second time, are you 100% sure you want to remove the dormer's record?");
		if (check2)
		{
			return true;
		}
...
<body onload="startTime()">	
   ...
   <div id="content">
    	<header>
            <h1>Confirm Remove Resident</h1>
        </header>
        <section>
       <br />


<form id="removeDormer" name="removeDormer" method="post" action="removeDormers" onsubmit="return checkStuff()">
	<table>
	<tbody>
	<?php
			foreach($data as $d){
	...
	<td colspan='2'>
	<input type="submit" value="Remove Dormer" onclick="" onSubmit="return checkStuff()"/>
	</td>
	</tr>
	</table>
</form>
