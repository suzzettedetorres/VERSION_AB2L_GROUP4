	...
	<div id="navigation">
    	<div id="div1"> 
                ...
                <div class="tile bg-color-blue" id="addApplicant">
                	<a href="goToAddApplicant"><img src="../../img/invisible-LINK.png" /></a>
                </div>
            	<div class="tile bg-color-blue" id="genReport">
           		...
           		<div class="tile bg-color-blue" id="sendEmail">
                	<a href="goToSendReport"><img src="../../img/invisible-LINK.png" /></a>
                </div>
    	</div>
        <div id="div2">
        ...
        <div id="div3">        	
        	<div class="tile double double-vertical bg-color-greenDark" id="manageResident">
            	<a href="goToManageResident"><img src="../../img/invisible-LINK-BIG.png" /></a>
            </div>
        </div>
        <div id="div4">        	
            <div class="tile bg-color-greenLight" id="room">
           	...
           	<div class="tile bg-color-blue" id="admin">
            	<a href="goToManageAdminAccount"><img src="../../img/invisible-LINK.png" /></a>
            </div>
        </div>
    </div>
    <div id="Main">
        <div id="slide">
         ...
         <div class="fg-color-white" id="title" style="padding-left:4em;">Women's Residence Hall Dormers Management System</div>
    	<div id="banner">This web-based database management system for Women's Residence Hall, one of the dormitories in the University of the Philippines Los Ba&ntilde;os will keep track of the records and data of the dormers including residents' personal information, contact details, payment records, reservation records, violation records, and records on usage of furniture, appliances, equipment and other resources.</div>
    </div>
</section>
<footer>
