...
<html>
<head>
<title>Add Dormer's Borrowed Equipment</title>
...
<body onload="startTime()">	
    ...
    <div id="content">
    	<header>
            <h1>Add Dormer's Borrowed Equipment</h1>
        </header>
        <section>
...
?>
<br/>
	<form id="borrowedequipmentForm" name="borrowedequipmentForm" method="post" action="addborrowedequipment" onsubmit="">
	<table>
	<tbody>
	...
	<select name="control_number" id="control_number">
	<?php
	foreach ($equipments as $listed_items) {
		echo "<option value=".$listed_items['CONTROLNUMBER'].">".$listed_items['CONTROLNUMBER'].'_'.$listed_items['EQUIPMENTNAME']."</option>";
	}
	?>
	</select>
	</div>
    ...
    <input name="borday" id="borday" size="2" type="number" min="1" max="31" value="<?php print $_day;?>" required/>
    </div>
	<div class="input-control number inputStyle" id="Y">Year:<br />
    <input name="boryear" id="boryear" size="4" type="number" min="1909" max="2013" value="<?php print $_year;?>" required/>
    </div>
    </div>
	</td>
	</tr>
    ...
    <td><div class="input-control text inputStyle">
    <input type="text" name="condb" id="condb" required/>
    </div></td>
	</tr>
	
	<tr><td></td>
	<td style="text-align:left" colspan='2'>
	<input type="submit" class="btn-three" value="Add Borrowed Equipment Record" onclick="" />
	</td></tr>
	</table>
</form>
<br />
