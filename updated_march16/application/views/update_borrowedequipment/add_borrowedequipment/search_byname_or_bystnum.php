    ...
    <div id="content">
        ...
        <section>
         <ul class="listview">
          <li>
           <div class="icon">
		   <a href="equip_searchByStudentNumber"><img src="../../img/search2.png" /></a>
           </div>
           <div class="data">
            <h4><a href="equip_searchByStudentNumber">Search by Student Number</a></h4>
            <p>Search resident by entering his/her student number.</p>
           </div>
          </li>
           <li>
           <div class="icon">
		   <a href="equip_searchByName"><img src="../../img/search2.png" /></a>
           </div>
           <div class="data">
            <h4><a href="equip_searchByName">Search by Name</a></h4>
