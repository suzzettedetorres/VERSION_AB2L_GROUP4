...
<body onload="startTime()">	
    ...
    <div id="content">
       ...
       <br />
		...
		<form id="addBorrowedEquipment" name="addBorrowedEquipment" method="post" action="addABorrowedEquipment" onsubmit="">
	<table>
	<tbody>
	<tr>
	<td>Student Number: </td>
	<td><input type="text" name="stnum" id="stnum" pattern="[0-9]{4}-[0-9]{5}"  required/></td>
	</tr>
