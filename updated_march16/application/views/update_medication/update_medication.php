...
<html>
<head>
<title>Update Dormer's Medication Record</title>
...
<body onload="startTime()">	
    ...
    <div id="content">
    	<header>
            <h1>Update Dormer's Medication Record</h1>
        </header>
        <section>
        <div id="box2">
        <div id="half">
		...
		<li>
           ...
           <div class="data">
            <h4><a href="goToAddMedication">Add a Dormer's Medication Record</a></h4>
        ...
        <li>
           <div class="icon">
            <a href="goToRemoveMedication"><img src="../../img/med.png" /></a>
           </div>
           <div class="data">
            <h4><a href="goToRemoveMedication">Remove a Dormer's Medication Record</a></h4>
            <p>Remove a medication from a dormer's record.</p>
           </div>
        </li>
        </ul>
        </div>
