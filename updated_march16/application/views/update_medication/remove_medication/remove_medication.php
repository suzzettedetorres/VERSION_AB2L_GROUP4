...
<html>
<head>
<title>Remove Dormer's Medication</title>
...
<body onload="startTime()">	
    ...
    <div id="content">
    	<header>
            <h1>Remove Dormer's Medication</h1>
        </header>
        <section>
...
?>
<br/>
	<form id="medicationForm" name="medicationForm" method="post" action="removemedication" onsubmit="">
	
	<?php
		echo '<h2><b>'.$_lname.', '.$_fname.' '.$_mname.'</b></h2><br/>';
		echo '<h2>'.$_stnum.'</h2>';
	?>
	...
	<input type="hidden" name="stnum" id="stnum" pattern="[0-9]{4}-[0-9]{5}" value="<?php print $_stnum ; ?>"  required/>
	
	<?php
		foreach($medication as $d){		
			print  '<tr><td><input type="radio" name="medicationid" value="'.$d['MEDICATION_KEY'].'">Ailment : '.$d['MEDICATION'].'</td></tr>';
		}
	?>
	
	<tr><td></td>
	<td style="text-align:left" colspan='2'>
	<input type="submit" class="btn-three" value="Remove Medication" onclick="" />
	</td></tr>
	</table>
</form>
<br />
