...
<body onload="startTime()">	
    ...
    <div id="content">
    	<header>
            <h1>Select Report To Send</h1>
        </header>
        <section>
         <ul class="listview">
          <li>
           <div class="icon">
		   <a href="goTo_send_violationReport"><img src="../../img/sendviolation.png" /></a>
           </div>
           <div class="data">
            <h4><a href="goTo_send_violationReport">Send Violation Report</a></h4>
            <p>Send the violation record(s) committed by the dormer, if there is any.</p>
           </div>
          </li>
		  <li>
           <div class="icon">
		   <a href="goTo_send_statusOfResidency"><img src="../../img/sendstatus.png" /></a>
           </div>
           <div class="data">
            <h4><a href="goTo_send_statusOfResidency">Send Status of Residency</a></h4>
            <p>Send the status of residency of the dormer.</p>
           </div>
          </li>
         </ul>
        </section>
