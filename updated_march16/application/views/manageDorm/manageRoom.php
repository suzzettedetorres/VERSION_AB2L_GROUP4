     ...
     <div id="content">
        ...
        <section>
         <ul class="listview">
		  ...
		  <li>
           <div class="icon">
	<a href="goToAddRoom"><img src="../../img/rooms.png" /></a>
           </div>
           <div class="data">
		  ...
		  <li>
           <div class="icon">
		    <a href="viewRooms"><img src="../../img/viewroom.png" /></a>
           </div>
           <div class="data">
		  ...
		  <li>
           <div class="icon">
            <a href="removeARoom"><img src="../../img/removeroom.png" /></a>
           </div>
           <div class="data">
            <h4><a href="removeARoom">Remove Rooms</a></h4>
            <p>Delete a room in the database.</p>
           </div>
          </li>
         </ul>
       <br />
