...
<html>
<head>
<title>Add Appliance Record</title>
...
<br/>
	<form id="applianceForm" name="applianceForm" method="post" action="addappliancewithfee" onsubmit="">
	<table>
	<tbody>
    ...
    <input type="text" name="appliance" id="appliance" required/></div></td>
	</tr>
	
	<tr>
	<td>Appliance Fee:</td>
    <td><div class="input-control text inputStyle">
    <input type="text" name="appliancefee" id="appliancefee" required/></div></td>
	</tr>
	
	<tr><td></td>
	<td style="text-align:left" colspan='2'>
	<input type="submit" class="btn-three" value="Add Appliance Record" onclick="" />
	</td></tr>
	</table>
</form>
<br />
