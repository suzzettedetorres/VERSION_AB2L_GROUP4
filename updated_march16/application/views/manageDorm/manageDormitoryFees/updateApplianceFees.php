...
<html>
<head>
<title>Update Appliance Fees</title>
...
<div id="infosheet">
       ...
       <br />
<br/>
	<form id="ApplianceFeesForm" name="ApplianceFeesForm" method="post" action="update_AppliancesFees" onsubmit="">
	<table>
	<tr>
	<td>Appliance</td>
	<td>Appliance Fee</td>
    ...
    echo '<input type="text" name="appliancefees'.$this_appliance.'" id="appliancefees'.$this_appliance.'" value="'.$a['APPLIANCEFEE'].'" required/>';
	echo '</div></td></tr>';
	}?>
	
	<tr><td></td>
	<td style="text-align:left" colspan='2'>
	<input type="submit" class="btn-three" value="Update Appliances Fee" onclick="" />
	</td></tr>
	</table>
</form>
<br />
