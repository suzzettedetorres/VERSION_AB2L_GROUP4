...
<html>
<head>
<title>Update STFAP Bracket Fees</title>
...
<body onload="startTime()">	
    ...
    <div id="content">
    	<header>
            <h1>Update STFAP Bracket Fees</h1>
        </header>
        <section>
...
<div id="infosheet">
       ...
       <br />
<br/>
	<form id="STFAPBracketFeesForm" name="STFAPBracketFeesForm" method="post" action="update_STFAPBracketFees" onsubmit="">
	<table>
	<tr>
	<td>BRACKET</td>
	<td>BRACKET Assigned Fee</td>
	</tr>
	...
	echo '<tr><td>';
	echo $b['BRACKET'];
	echo'</td><td><div class="input-control text inputStyle">';
    echo '<input type="text" name="bracketFee'.$b['BRACKET'].'" id="bracketFee'.$b['BRACKET'].'" value="'.$b['RESIDENCEFEE'].'" required/>';
	echo '</div></td></tr>';
	}?>
	
	<tr><td></td>
	<td style="text-align:left" colspan='2'>
	<input type="submit" class="btn-three" value="Update Residence Fee" onclick="" />
	</td></tr>
	</table>
</form>
<br />
