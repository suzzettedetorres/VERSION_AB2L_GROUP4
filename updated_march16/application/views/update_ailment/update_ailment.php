...
<html>
<head>
<title>Update Dormer's Ailment Record</title>
...
<body onload="startTime()">	
    ...
    <div id="content">
    	<header>
            <h1>Update Dormer's Ailment Record</h1>
        </header>
        <section>
        <div id="box2">
        <div id="half">
		...
		<li>
           ...
           <div class="data">
            <h4><a href="goToAddAilment">Add a Dormer's Ailment Record</a></h4>
        ...
        <li>
           <div class="icon">
            <a href="goToRemoveAilment"><img src="../../img/ailment.png" /></a>
           </div>
           <div class="data">
            <h4><a href="goToRemoveAilment">Remove a Dormer's Ailment Record</a></h4>
            <p>Remove an ailment from a dormer's record.</p>
           </div>
        </li>
        </ul>
        </div>
