...
<html>
<head>
<title>Remove Dormer's Ailment</title>
...
?>
<br/>
	<form id="AilmentForm" name="AilmentForm" method="post" action="removeailment" onsubmit="">
	<?php
	...
	<?php
		foreach($ailment as $d){		
			print  '<tr><td><input type="radio" name="ailmentid" value="'.$d['AILMENT_KEY'].'">Ailment : '.$d['AILMENT'].'</td></tr>';
		}
	?>
	
	<tr><td></td>
	<td style="text-align:left" colspan='2'>
	<input type="submit" class="btn-three" value="Remove Ailment" onclick="" />
	</td></tr>
	</table>
</form>
<br />
