...
<html>
<head>
<title>Update Dormer's Affiliation Record</title>
...
<body onload="startTime()">	
    ...
    <div id="content">
    	<header>
            <h1>Update Dormer's Affiliation Record</h1>
        </header>
        <section>
        <div id="box2">
        <div id="half">
        ...
        <li>
           <div class="icon">
            <a href="goToRemoveAffiliation"><img src="../../img/affiliation.png" /></a>
           </div>
           <div class="data">
            <h4><a href="goToRemoveAffiliation">Remove a Dormer's Affiliation</a></h4>
            <p>Remove an affiliation from a dormer's record.</p>
           </div>
        </li>
        </ul>
        </div>
