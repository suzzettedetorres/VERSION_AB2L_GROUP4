...
<html>
<head>
<title>Remove Dormer's Affiliation</title>
...
<body onload="startTime()">	
    ...
    <div id="content">
    	<header>
            <h1>Remove Dormer's Affiliation</h1>
        </header>
        <section>
...
?>
<br/>
	<form id="AffiliationForm" name="AffiliationForm" method="post" action="removeaffiliation" onsubmit="">
	<?php
	...
	<?php
		foreach($affiliations as $d){		
			print  '<tr><td><input type="radio" name="affiliationid" value="'.$d['AFFILIATION_ID'].'">Affiliation : '.$d['AFFILIATION'].'</td></tr>';
		}?>
	
	<tr><td></td>
	<td style="text-align:left" colspan='2'>
	<input type="submit" class="btn-three" value="Remove Affiliation" onclick="" />
	</td></tr>
	</table>
</form>
<br />
