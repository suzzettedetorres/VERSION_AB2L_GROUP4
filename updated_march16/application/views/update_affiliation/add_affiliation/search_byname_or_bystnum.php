...
<html>
<head>
<title>Add Dormer's Affiliation</title>
...
<body onload="startTime()">	
    ...
    <div id="content">
    	<header>
            <h1>Add Dormer's Affiliation</h1>
        </header>
        <section>
         <ul class="listview">
          <li>
           <div class="icon">
		   <a href="aff_searchByStudentNumber"><img src="../../img/search2.png" /></a>
           </div>
           <div class="data">
            <h4><a href="aff_searchByStudentNumber">Search by Student Number</a></h4>
            <p>Search resident by entering his/her student number.</p>
           </div>
          </li>
           <li>
           <div class="icon">
		   <a href="aff_searchByName"><img src="../../img/search2.png" /></a>
           </div>
           <div class="data">
            <h4><a href="aff_searchByName">Search by Name</a></h4>
