...
<html>
<head>
<title>Choose Dormer to Generate Fee</title>
...
<body onload="startTime()">	
    ...
    <div id="content">
    	<header>
            <h1>Choose Dormer to Generate Fee</h1>
        </header>
        <section>
...
<div id="infosheet">
<form id="viewDormer" name="viewDormer" method="post" action="generateFee" onsubmit="">
	<table>
	<tbody>
	<?php
			foreach($data as $d){
				
				print  '<tr><td><pre> <label class="input-control radio"><input type="radio" name="stnum" value="'.$d['STUDENTNUMBER'].'"><span class="helper">  <b>Student Number: </b>'.$d['STUDENTNUMBER'].'</td><td> <b>Name:</b>'.$d['LASTNAME'].', '.$d['FIRSTNAME'].' '.$d['MIDDLENAME'].'</span></label></pre></td></tr>';
				
			}
	?>
	
	<td colspan='2'>
	<input type="submit" class="btn-three" value="Choose Dormer" onclick="" />
	</td>
	</tr>
	</table>
</form>
