...
<table id ="forms">
				<form name="form1" action = "javascript:exportToPDF()">
					...
					<td>
						<td>Appliance Fee &nbsp;</td>
						<td><input type = "text" id = "afee" name = "afee" /></td>
					</td>
					<td>
						<input type="date" name="adate" />
					</td>
					<td>
						<input type="date" name="adate2" />
					</td>
					</tr>
					<tr>
					<td>
						<td>Transient Fee &nbsp;</td>
						<td><input type = "text" id = "tfee" name = "tfee" /></td>
					</td>
					<td>
						<input type="date" name="tdate" />
					</td>
					<td>
						<input type="date" name="tdate2" />
					</td>
					</tr>
					<tr>
					<td>
	...
	<script type="text/javascript">
		function exportToPDF() {
			...
			doc.setFontSize(11);
			if(adate==" " || afee==" " || adate2==" ") doc.text(80,140, adate+' to '+adate2);
			doc.setFontSize(16);
